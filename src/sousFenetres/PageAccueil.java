...
public class PageAccueil extends JPanel {
	...
	// Fonction de cr�ation des boutons + Effet Hover pour chacun
	...
	// Initialisation des diff�rentes pages de l'appli
	...
	// Fonction onClick permettant de passer aux diff�rentes rubriques de l'appli
